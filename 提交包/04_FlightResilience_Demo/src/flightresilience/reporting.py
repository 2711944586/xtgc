...
def generate_script() -> Path:
    ...
    script = f"""# FlightResilience 7分30秒讲稿（13页版）
...
详细稿：打开静态 Web 后点击“自动演示”。第一段确认样本范围、机场航线规模和主推荐；第二段会切换关注机场并点击关键性条形；第三段会点击航线风险气泡，再调节起飞小时和机场拥堵滑杆，看到风险概率变化；第四段会真实点击网络节点，联动机场画像；第五段会切换天气或枢纽冲击情景、重点策略和冲击机场；第六段会把 λ 从 0.9 调到 0.2，并点击风险-TOPSIS 图上的策略点，展示推荐换位边界。当前主结果中排名第一策略的平均累计延误约为 {top['cumulative_delay']:.0f}，平均恢复时间约 {top['recovery_time']:.1f} 小时。
